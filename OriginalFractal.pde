...
int howLongIsBolt = 90;// 55 how long is the maximum length of the bolt?
...
SoundFile thunderSoundFile;  // the soundfile that stores the thunder sound
...
thunderCountDown--; //each time we enter draw, we decrement the value of thunderCountDown.
